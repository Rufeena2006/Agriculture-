...
1. Overview
AgriEdge is a smart agriculture platform that uses modern technologies like AI, IoT, sensors, and data analytics to improve farming.
It helps farmers make better decisions using real-time data
Connects farmers with technology, research, and markets
Focuses on sustainable, profitable, and efficient farming �
AgriEdge
Main goal:
“Transform data into useful farming decisions.”
3. Features
 * Real-time crop monitoring using sensors and satellite data
 * Smart irrigation system (water only when needed)
 * Fertilizer optimization (right amount, right time)
